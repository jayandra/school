...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { hours: @classroom.hours, name: @classroom.name, room_number: @classroom.room_number }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { hours: @classroom.hours, name: @classroom.name, room_number: @classroom.room_number }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
